...
// ─── Component ────────────────────────────────────────────────────────────────
/** Original hardcoded partner landing page.
 * Rendered only when the CMS page has never been published, so the site is
 * never blank before an admin publishes for the first time. */
export function StaticPartnerLanding() {

...
export default function SignupPage() {
  ...
  const { signupEmail, setSignupEmail, signupStep, setSignupStep, resetSignup } = useAuth();
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    await new Promise((resolve) => setTimeout(resolve, 1000));
    console.log("Signup complete:", { email: signupEmail, name, mobile });
    resetSignup();
          ...
          {step !== 4 && (
            <div
              className={`flex-1 h-0.5 mx-2 transition-all ${
                step < signupStep ? "bg-[#D9FC67]" : "bg-white/10"
              }`}
            />
          )}
        </div>
    ...
    <>
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-[#141414] text-white/40">Or sign up with email</span>
        </div>
      </div>
    ...
    <>
      <div className="text-center mb-8">
        ...
        <p className="text-white/60 text-sm">
          We sent a 6-digit code to <span className="text-[#D9FC67]">{signupEmail}</span>
        </p>
      </div>
      ...
      <form onSubmit={handleOtpSubmit} className="space-y-6">
        ...
        <div className="text-center">
          ...
          >
            Wrong email? <span className="text-[#D9FC67]">Change it</span>
          </button>
        </div>
  ...
  const renderPasswordStep = () => (
    <>
      <div className="text-center mb-8">
        ...
        <p className="text-white/60 text-sm">Secure your account with a strong password</p>
      </div>
  ...
  return (
    <div className="bg-[#141414] border border-white/10 rounded-2xl p-8 shadow-2xl">
      ...
      {signupStep === 1 && renderEmailStep()}
      {signupStep === 2 && renderOtpStep()}
      {signupStep === 3 && renderPasswordStep()}
      {signupStep === 4 && renderProfileStep()}
      ...
      <p className="mt-6 text-center text-sm text-white/60">
        ...
        <Link
          href="/auth/login"
          className="text-[#D9FC67] hover:text-[#E8FF8A] font-medium transition-colors"
        >
          Sign in
        </Link>
      </p>

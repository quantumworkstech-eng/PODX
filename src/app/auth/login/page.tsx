  ...
  return (
    <div className="bg-[#141414] border border-white/10 rounded-2xl p-8 shadow-2xl">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">PodX</h1>
        <p className="text-white/60 text-sm">Welcome back to your podcast studio</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end">
          <Link
            ...
            className="text-sm text-[#D9FC67] hover:text-[#E8FF8A] transition-colors"
          >
            Forgot password?
          </Link>
        </div>
